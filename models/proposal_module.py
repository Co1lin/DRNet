...
class ProposalModule(pl.LightningModule):
    def __init__(self, cfg):
        ...
        '''Parameters'''
        self.num_class = self.dataset_config.num_class
        self.num_heading_bin = self.dataset_config.num_heading_bin
    ...
    def forward(self, xyz, features, end_points, export_proposal_feature=False):
        r"""
        :param xyz: (B,K,3)
        :param features: (B,C,K)
        :return: scores: (B,num_proposal,2+3+NH*2+NS*4)
        """
